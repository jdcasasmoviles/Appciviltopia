...
public class MapaReceptores extends AppCompatActivity {
    String Respuesta="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapa_receptores);
     ...
     while (!Respuesta.equals("")) {
         ...
         //mocha la cadena desde * en adelante hasta el final
         Respuesta = Respuesta.substring(Respuesta.indexOf('*') + 1, Respuesta.length());
         System.out.println("Antes del while" + coorX + " " + coorY + " " + fila + " " + fila2);
         ;
         setUpMapIfNeeded();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_main_mapa_georeceptores, menu);
        return true;
    }
}
